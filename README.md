...
- ✅ **数据过滤** - 快速筛选符合条件的数据
- ✅ **表头排序** - 点击列标题即可排序
- ✅ **缩放功能** - Ctrl+Plus / Ctrl+Minus 调整视图大小
- ✅ **视图导出** - 支持按当前视图或全部数据导出
...
- [x] v1.1.0 - AI 助手、编辑功能、撤销重做（2026-04-17）
- [ ] v1.2.0 - 搜索高亮、冻结行列、数据验证
- [ ] v1.3.0 - 条件格式、公式支持、数据透视表
